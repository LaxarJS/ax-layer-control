...
define( [
   ...
   'laxar',
   './lib/layer_utils',
   './lib/layer_anchor_positioning',
   './lib/layer_fixed_positioning',
   './lib/layer_absolute_positioning'
], function( $, ng, ax, layerUtils, layerAnchorPositioning, layerFixedPositioning, layerAbsolutePositioning ) {
   'use strict';
